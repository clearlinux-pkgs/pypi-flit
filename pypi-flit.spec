...
Source0  : https://files.pythonhosted.org/packages/8b/c1/3482d40966e55808bae4dbd8b158c700146ed5d916cc98f0f5dcb4e23add/flit-3.11.0.tar.gz
...
%prep
%setup -q -n flit-3.11.0
cd %{_builddir}/flit-3.11.0
pushd ..
cp -a flit-3.11.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739990181
