...
%prep
%setup -q -n flit-3.7.1
cd %{_builddir}/flit-3.7.1
pushd ..
cp -a flit-3.7.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656404616
...
cp %{_builddir}/flit-3.7.1/LICENSE %{buildroot}/usr/share/package-licenses/pypi-flit/12276565e762cd50328b99b71e0343d3d99350a0
cp %{_builddir}/flit-3.7.1/flit_core/flit_core/vendor/tomli-1.2.3.dist-info/LICENSE %{buildroot}/usr/share/package-licenses/pypi-flit/9da6ca26337a886fb3e8d30efd4aeda623dc9ade
