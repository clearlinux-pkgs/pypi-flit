...
Source0  : https://files.pythonhosted.org/packages/b1/a6/e9227cbb501aee4fa4a52517d3868214036a7b085d96bd1e4bbfc67ad6c6/flit-3.9.0.tar.gz
...
%prep
%setup -q -n flit-3.9.0
cd %{_builddir}/flit-3.9.0
pushd ..
cp -a flit-3.9.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1684174058
